...
def get_image():
    if request.args.get('name') == 'visible':
       filename = 'output\\images\\thermal-outputs.png'
    elif request.args.get('name') == 'thermal':
       filename = 'uploads\\thermal.jpg'
...
def generate_visible():
    ...
    a.input_dir = 'uploads'
    a.output_dir = 'output'
    a.checkpoint = 'E:\TrainSet\OUTPUT_MODEL'
    EPS = 1e-12
    CROP_SIZE = 256
    ...
    def load_examples():
        ...
        with tf.name_scope("load_images"):
            ...
            if a.lab_colorization:
                ...
                a_images = preprocess(raw_input[:, :width, :])
                b_images = preprocess(raw_input[:, :width, :])
